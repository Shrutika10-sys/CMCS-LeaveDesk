      ...
      <div className="mt-24 max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            {
              name: "Shrutika Pawar",
              role: "Project Lead & Deployment Lead",
              desc: "Coordinated project workflow, conducted weekly status briefings, managed version control and handled application deployment.",
            },
            {
              name: "P.D. Jadhav",
              role: "HOD",
